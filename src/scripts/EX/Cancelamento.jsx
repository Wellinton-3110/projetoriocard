...
export function Cancelamento(props) {
  ...
  return (
    <div className="w-full h-[75vh] flex items-center justify-center overflow-hidden">
      <div className="animateCard bgScriptEx overflow-hidden flex flex-col relative w-[75vw] h-[71vh] m-auto text-center border-t-[1px] border-b-[2px] border-r-[3px] border-l-[4.5px] border-black/80 rounded-lg p-3 sm:h-[590px] md:h-[590px] sm:w-[350px] tall:h-[65vh]">
        <div className="flex flex-col items-center justify-center flex-1 ">
          <h1 className="ml-6 font-black [font-size:25px] [letter-spacing:1px] underline [line-height:40px] absolute top-5 tall:text-[19px] tall:top-1">
            {props.title}
            <h3 className="text-[14px] font-light text-white animate-bounce no-underline">
              (*Abrir demanda somente com o titular)
            </h3>
          </h1>
          <h2
            id="copy"
            className="font-bold [font-size:17px] [letter-spacing:1px] max-w-[650px] sm:w-[230px] tall:text-[11px] sm:font-normal md:w-[330px]"
          >
            <p>NOME:</p>
            <p>CPF:</p>
            <p>CARTÃO:</p>

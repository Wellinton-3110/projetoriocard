...
export function NaoIntegracao(props) {
  ...
  return (
    <div className="w-full h-[75.5vh] flex items-center justify-center overflow-hidden">
      <div className="animateCard bgScriptEx overflow-hidden flex flex-col relative w-[75vw] h-[71vh] m-auto text-center border-4 border-t-[1px] border-b-[8px] border-r-[5px] border-l-[6px] border-black/80 rounded-lg p-3 sm:h-[590px] md:h-[590px] sm:w-[350px] tall:h-[67vh]">
        <div className="flex flex-col items-center justify-center flex-1 h-[100%] ">
          ...
          <h2
            id="copy"
            className="font-bold absolute top-[8vh] [font-size:15px] [letter-spacing:3px] w-[750px] sm:w-[230px] sm:font-normal md:w-[330px] tall:text-[10px] md:text-[12px] sm:text-[10px]"
          >
            {props.script}
            <br />
            <br />
            <p>Dados para abertura da ocorrência:</p>
            <div className="flex flex-col text-left font-light text-[12px] [line-height:17px] tall:text-[9px] md:text-[10px] md:text-center sm:text-[7px]">
              <br />
              <br />
              <p>Nome do Usuário:</p>
              <p>Nº do CPF:</p>

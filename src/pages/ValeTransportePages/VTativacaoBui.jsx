...
export function VTativacaoBui() {
  ...
  const script =
    'Cliente solicita orientações para ativação do bilhete único no seu cartão vale transporte, ciente de criar um cadastro no site da riocard "para empresas", declarar renda no site riobilheteunico.com.br/declaracao e após um prazo máximo de 48 horas, solicitar ativação por meio do site para empresas, assim, após mais 48 horas pode validar pelo app Valida+ ou aproximando o cartão de um Terminal de Consulta.';
